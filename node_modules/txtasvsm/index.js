...
exports.run_vsm_system = function (filePath, cb) {
    var _file = fs.readFileSync(filePath);
    ...
    buildvsm.build(sentences, 0, function (vsm) {
        var vsmFilePath = filePath.replace(".txt","_vsm.txt");
        var vsmTowrite = "";
        var br = "\n";
        ...
        vsmfile.on('error', function (err) { console.log("VSM_Error:" + err); });
